...
/** @var $searchModel api\modules\cms\models\search\ArticleBannerSearch */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = ArticleBanner::$modelName . '管理';
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            return ArticleBanner::$bannerTypeOptions[$model->banner_type] ?? '';
                        }
                    ],
                    'title',
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($model) {
                            return Yii::$app->formatter->asImage($model->image, ['width' => 40]);
                        }
                    ],
                    [
                        'attribute' => 'is_href',
